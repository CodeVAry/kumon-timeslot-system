...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:justify-end">
        ...
        <a
            href="{{ route('admin.student-import.index') }}"
            class="inline-flex h-12 items-center justify-center rounded-xl border border-slate-300 bg-white px-6 font-semibold text-slate-700 hover:bg-slate-50"
        >
            Cancel
        </a>
        ...
        @if ($readyRows->isNotEmpty())
            ...
            >
                ...
                <button
                    ...
                    onclick="
                        return confirm(
                            'Import only the new students and new/reactivated allocations shown above?'
                        );
                    "
                    class="inline-flex h-12 w-full items-center justify-center rounded-xl bg-green-600 px-7 font-bold text-white shadow-sm hover:bg-green-700 sm:w-auto"
                >
                    Confirm Import
                </button>
        ...
        @else
            ...
            <button
                type="button"
                disabled
                class="inline-flex h-12 cursor-not-allowed items-center justify-center rounded-xl bg-slate-300 px-7 font-bold text-white"
            >
