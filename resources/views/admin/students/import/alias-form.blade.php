...
>
    ...
    <div class="mb-3">
        ...
        <label class="mb-4 flex w-full cursor-pointer items-center gap-4 rounded-xl border-2 border-blue-500 bg-blue-100 px-4 py-4 shadow-sm hover:bg-blue-200">
            <input type="checkbox" form="import-confirm-form"
                   name="matches[{{ $matchIndex }}][selected]" value="1" data-match-check
                   @checked(old("matches.$matchIndex.selected"))
                   class="h-6 w-6 shrink-0 cursor-pointer rounded border-2 border-blue-600 accent-blue-600">
            <span class="flex flex-col gap-1">
                <span class="text-sm font-bold text-blue-900">Select this student for import</span>
                <span class="text-xs font-medium text-blue-700">Check this box after choosing the correct profile below.</span>
            </span>
        </label>
    ...
    @else
        ...
        <div class="space-y-3">
            ...
            <input type="hidden" form="import-confirm-form"
                   name="matches[{{ $matchIndex }}][source_name]"
            ...
            <div>
                ...
                <select
                    ...
                    name="matches[{{ $matchIndex }}][target_external_id]"

                    form="import-confirm-form"
        ...
        <script>
            ...
            */
            ...
            function selectSuggestedStudent_{{ $formKey }}(
                ...
                const check = select.closest('[data-match-row]').querySelector('[data-match-check]');
                check.checked = true;
