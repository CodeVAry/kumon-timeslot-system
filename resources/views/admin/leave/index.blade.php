    ...
    ========================================================== --}}
        ...
        <div
            ...
            <div class="flex
                ...
                <a href="{{ route('admin.leave.history') }}"
                    class="inline-flex
                       h-11
                       items-center
                       justify-center
            ...
            <div class="flex
                ...
                <a href="{{ route('admin.leave.index', [
                    ...
                    class="px-7 py-4
                       ...
                       font-semibold
                       transition
                    {{ $tab === 'current' ? 'border-b-2 border-blue-600 text-blue-700' : 'text-slate-500 hover:text-blue-600' }}">
                    Current Leave
                </a>
                ...
                <a href="{{ route('admin.leave.index', [
                    ...
                    class="px-7 py-4
                       ...
                       font-semibold
                       transition
                    {{ $tab === 'upcoming' ? 'border-b-2 border-blue-600 text-blue-700' : 'text-slate-500 hover:text-blue-600' }}">
                    Upcoming Leave
                </a>
