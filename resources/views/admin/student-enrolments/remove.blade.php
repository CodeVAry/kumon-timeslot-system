...
<div class="space-y-6">
    ...
    <a
        ...
        class="inline-flex text-sm font-semibold text-blue-600 hover:text-blue-700"
    >
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    @forelse ($enrolments as $enrolment)
                        ...
                        @php
                            ...
                            $subSection = $enrolment->subSection;
                        @endphp
                        ...
                        <tr class="transition hover:bg-slate-50">
                            ...
                            <td class="px-6 py-5 text-right">
                                ...
                                >
                                    ...
                                    <button
                                        type="submit"
                                        class="inline-flex rounded-xl border border-red-200 bg-red-50 px-4 py-2 text-sm font-semibold text-red-600 transition hover:bg-red-100"
                                    >
                                        Remove
                                    </button>
                    ...
                    @empty
                        ...
                        <tr>
                            ...
                            <td colspan="5" class="px-6 py-14 text-center text-sm text-slate-500">
                                This student has no current classes.
                            </td>
