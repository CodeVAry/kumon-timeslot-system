...
@section('content')
    ...
    */
        ...
        $homeworkLabels = [
            'none_required' => 'No Homework',

            'same_as_normal' => 'Normal',
    ...
    */
        ...
        $duration = $leave->start_date->diffInDays($leave->expected_return_date);
    ...
    */
        ...
        if ($leave->homework_requirement === 'increase') {
            $homeworkBox = 'border-violet-200 bg-violet-50';

            $homeworkBadge = 'bg-violet-100 text-violet-700';

            $homeworkText = 'text-violet-700';
        } elseif ($leave->homework_requirement === 'decrease') {
            $homeworkBox = 'border-orange-200 bg-orange-50';

            $homeworkBadge = 'bg-orange-100 text-orange-700';

            $homeworkText = 'text-orange-700';
        } elseif ($leave->homework_requirement === 'none_required') {
            $homeworkBox = 'border-slate-200 bg-slate-50';

            $homeworkBadge = 'bg-slate-200 text-slate-600';

            $homeworkText = 'text-slate-600';
        } else {
            $homeworkBox = 'border-blue-200 bg-blue-50';

            $homeworkBadge = 'bg-blue-100 text-blue-700';

            $homeworkText = 'text-blue-700';
        }
    ...
    */
        ...
        if ($leave->status === 'pending') {
            ...
            $displayStatusClass = 'bg-amber-100 text-amber-700';
            ...
            $displayStatusClass = 'bg-purple-100 text-purple-700';

            $headerBorder = 'border-purple-200';
        } else {
            $displayStatus = 'Current Leave';
                        ...
                        <div
                            ...
                            <p
                                class="mt-2
                                   ...
                                   font-bold
                                   text-slate-900">
                                {{ $leave->actual_return_date ? $leave->actual_return_date->format('d M Y') : 'Not returned yet' }}
                            </p>
                        ...
                        <div
                            ...
                            <p
                                class="mt-4
                                   ...
                                   leading-6
                                   text-slate-700">
                                {{ $leave->notes ?: 'No note was provided.' }}
                            </p>
                    ...
                    <div
                        ...
                        <span
                            class="inline-flex
                               ...
                               font-bold
                               {{ $homeworkBadge }}">
                            {{ $homeworkLabels[$leave->homework_requirement] ?? $leave->homework_requirement }}
                        </span>
            ...
            ================================================== --}}
                ...
                @if ($leave->status === 'pending')
                    ...
                    <section
                        ...
                        <div
                            ...
                            @if ($canCancel)
                                <form method="POST"
                                    action="{{ route('parent.leave.cancel', $leave) }}">
                ...
                @elseif (
                    $leave->status === 'approved' &&
                        ...
                        $leave->start_date->copy()->startOfDay()->gt($today))
                    <section
                        class="rounded-[26px]
                           border
                           border-purple-200
                    ...
                    <section id="early-return"
                        ...
                        <p
                            class="mt-2
                               ...
                               leading-6
                               text-green-700">
                            Record or change the student's return date. You can update it more than once.
                        </p>



                        <form method="POST"
                            action="{{ route('parent.leave.return-early', $leave) }}"
                            class="mt-5">
                            ...
                            <input type="date" id="actual_return_date" name="actual_return_date"
                                value="{{ old(
                                    'actual_return_date',
                                    $leave->actual_return_date ? $leave->actual_return_date->format('Y-m-d') : now()->toDateString(),
                                ) }}"
                                min="{{ now()->toDateString() }}"
                                max="{{ $leave->expected_return_date->format('Y-m-d') }}"
                                required
                                class="h-11
                                   w-full
                                   rounded-xl
                            ...
                            <p
                                class="mt-2
                                   ...
                                   leading-5
                                   text-green-700">
                                You can change this date more than once.
                                Past dates cannot be selected, and the date
                                cannot be after the expected return date.
                            </p>
                            ...
                            "
                                class="mt-4
                                   ...
                                   text-white
                                   hover:bg-green-700">
                                {{ $leave->actual_return_date ? 'Change Return Date' : 'Record Return Date' }}
                            </button>
                    ...
                    <section
                        ...
                        <div class="flex
                            ...
                            <div>
                                ...
                                <p class="font-bold
                                       text-green-800">
                                    {{ $leave->returned_early ? 'Returned Early' : 'Leave Completed' }}
                                </p>
            ...
            ================================================== --}}
                ...
                @if ($canDelete)
                    <section
                        ...
                        <form method="POST"
                            action="{{ route('parent.leave.destroy', $leave) }}"
                            class="mt-5">
